// app/(dashboard)/coverletter/[id]/edit/page.tsx

import type { Metadata } from "next";
import Link from "next/link";
import { Sparkles } from "lucide-react";
import { COVER_LETTER_THEME_REGISTRY } from "../../templates/templateRegistry";
import CoverLetterTemplateCard from "@/app/components/coverletter/CoverLetterTemplateCard";

export const metadata: Metadata = {
  title: "Edit Cover Letter | Smart CareerOS",
  description:
